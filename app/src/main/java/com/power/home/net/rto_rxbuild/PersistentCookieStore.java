...
//        boolean contains = uri.getPath().contains("api/member/logOut");
//        if (contains) {
//            cookies.clear();
...
//        } else {
            ...
            SharedPreferences.Editor prefsWriter = cookiePrefs.edit();
            prefsWriter.putString(cookie.getDomain(), TextUtils.join(",", ((ConcurrentMap) cookies.get(cookie.getDomain())).keySet()));
