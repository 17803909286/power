            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mChangePosition) {
                        ...
                        mSeekTimePosition = (int) (mGestureDownPosition + 0.1 * deltaX * totalTimeDuration / mScreenWidth);
...
//        Log.d(TAG, "onProgress: progress=" + progress + " position=" + position + " duration=" + duration);
    ...
    public void autoQuitFullscreen() {
        if ((System.currentTimeMillis() - lastAutoFullscreenTime) > 1000
//                && CURRENT_JZVD != null
                && state == STATE_PLAYING
                && screen == SCREEN_FULLSCREEN) {
...
//            }
    ...
    public static class JZAutoFullscreenListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {//可以得到传感器实时测量出来的变化值
            ...
            if (fullTag && newOrientation == 0) {
                Log.e(TAG, "onSensorChanged:1111     " + x);
                if (x > -1 && x < 1) {
                    Log.e(TAG, "onSensorChanged:2222 ");
                    if ((System.currentTimeMillis() - lastAutoFullscreenTime) > 500) {
                        Log.e(TAG, "onSensorChanged: 3333");
                        fullTag = false;
                        if (Jzvd.CURRENT_JZVD != null) Jzvd.CURRENT_JZVD.autoQuitFullscreen();
                        lastAutoFullscreenTime = System.currentTimeMillis();
                        Log.e(TAG, "onSensorChanged:4444 ");
                    }
